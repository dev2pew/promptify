...
_DEFAULT_THEME_STYLES = {
    ...
    "dialog": "bg:#101317 #f2f5f8",
    "dialog.body": "bg:#171c22 #f2f5f8",
    "dialog frame.label": "bg:#101317 #d7e6f6 bold",
    "dialog shadow": "bg:#050608",
    "button": "bg:#22303d #d7e6f6",
    "button.focused": "bg:#1f5d8e #f7fbff bold",
    "button.arrow": "#d7e6f6",
    "button.text": "#d7e6f6",
    "button.focused.arrow": "#f7fbff bold",
    "button.focused.text": "#f7fbff bold",
    "radio-list": "bg:#171c22 #f2f5f8",
    "radio": "#c9d4df",
    "radio-selected": "bg:#22303d #f7fbff",
    "radio-checked": "#8fe5b8 bold",
    "restore-session.header": "bg:#0f1419 #8fa5bb bold",
    "restore-session.separator": "#5e6b78",
    "restore-session.timestamp": "#d7e6f6",
    "restore-session.case": "#8fe5b8 bold",
    "restore-session.path": "#ffd89a",
    "err-frame": "bg:#101317",
...
_THEME_ENV_MAP = {
    ...
    "PROMPTIFY_THEME_SEARCH_TOGGLE_ON": "search-toggle-on",
    ...
    "PROMPTIFY_THEME_DIALOG": "dialog",
    "PROMPTIFY_THEME_DIALOG_BODY": "dialog.body",
    "PROMPTIFY_THEME_DIALOG_FRAME_LABEL": "dialog frame.label",
    "PROMPTIFY_THEME_DIALOG_SHADOW": "dialog shadow",
    "PROMPTIFY_THEME_DIALOG_BUTTON": "button",
    "PROMPTIFY_THEME_DIALOG_BUTTON_FOCUSED": "button.focused",
    "PROMPTIFY_THEME_DIALOG_BUTTON_ARROW": "button.arrow",
    "PROMPTIFY_THEME_DIALOG_BUTTON_TEXT": "button.text",
    "PROMPTIFY_THEME_DIALOG_BUTTON_FOCUSED_ARROW": "button.focused.arrow",
    "PROMPTIFY_THEME_DIALOG_BUTTON_FOCUSED_TEXT": "button.focused.text",
    "PROMPTIFY_THEME_DIALOG_RADIO_LIST": "radio-list",
    "PROMPTIFY_THEME_DIALOG_RADIO": "radio",
    "PROMPTIFY_THEME_DIALOG_RADIO_SELECTED": "radio-selected",
    "PROMPTIFY_THEME_DIALOG_RADIO_CHECKED": "radio-checked",
    "PROMPTIFY_THEME_RESTORE_SESSION_HEADER": "restore-session.header",
    "PROMPTIFY_THEME_RESTORE_SESSION_SEPARATOR": "restore-session.separator",
    "PROMPTIFY_THEME_RESTORE_SESSION_TIMESTAMP": "restore-session.timestamp",
    "PROMPTIFY_THEME_RESTORE_SESSION_CASE": "restore-session.case",
    "PROMPTIFY_THEME_RESTORE_SESSION_PATH": "restore-session.path",
